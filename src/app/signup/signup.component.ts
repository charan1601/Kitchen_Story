...
export class SignupComponent implements OnInit {
  ...
  constructor(private toastr: ToastrService, private http:HttpClient, private service:CharanService, private formbuilder:FormBuilder) {
    // this.signupForm = this.formbuilder.group({
    //   Charan:["",[Validators.required, Validators.email]],
